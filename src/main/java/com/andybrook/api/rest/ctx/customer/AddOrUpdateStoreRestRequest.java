...
public class AddOrUpdateStoreRestRequest extends CustomerRestRequest {
    ...
    public AddOrUpdateStoreRestRequest setCustomerId(Long customerId) {
    ...
    public AddOrUpdateStoreRestRequest setOwnerCompagnyName(String ownerCompagnyName) {
    ...
    public AddOrUpdateStoreRestRequest setStoreAddress(Address storeAddress) {
